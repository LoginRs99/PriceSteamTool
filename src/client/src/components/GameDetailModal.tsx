                  ...
                  <div>
                          ...
                          return (
                            ...
                            >
                              ...
                              <button
                                ...
                                onClick={() => handleApplyAksOverride(cand.slug || cand.id)}
                    ...
                    <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
                      <input
                        ...
                        onChange={e => setCustomAksInput(e.target.value)}
                        style={{
                          flex: 1,
                          minWidth: 240,
                          padding: '6px 10px',
                      ...
                      <button
                        ...
                        onClick={() => handleApplyAksOverride(customAksInput.trim())}
                        className="btn btn-primary"
